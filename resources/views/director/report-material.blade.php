@extends("layouts.app", ["title" => "Остаток на сырьё"])
            ...
            <div class="container mt-2">
                <div class="card">
                    <div class="card-header">
                        <h2 class="h5 mb-0">Остаток на сырьё</h2>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card shadow mb-4 mt-3">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">Остаток на сырьё</h6>
                    </div>
                    <div class="card-body">
