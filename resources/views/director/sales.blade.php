@extends("layouts.app", ["title" => "Оборот"])
                ...
                >
                    <div class="card shadow mb-4 mt-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">Оборот</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">2020/02/09</td>
                                        <td class="text-center">1</td>
                                    </tr>
                                    <tr>
