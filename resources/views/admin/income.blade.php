@extends("layouts.app", ["title" => "Другие приходы"])
...
@section("income")
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container">
                <h2 class="text-center mb-4">Другие приходы</h2>
                <div class="row">
                    <div class="form-group col-sm">
                        <label for="date">Наименование : </label>
                ...
                >
                    <div class="card shadow mb-4 mt-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">Другие приходы</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">150 500</td>
