@extends("layouts.app", ["title" => "Оплата, Обмен"])

@section("payment-exchange")
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container mt-2">
                <h2 class="text-center mb-4">Оплата, Обмен</h2>
                <hr>
                <div class="row mt-3">
                    ...
                    <div class="form-group col-sm">
                        ...
                        <input type="text" class="form-control" placeholder="Количество" name="amount">
                    </div>
                    <div class="form-group col-sm">
                        <label for="amount">Цена</label>
                        <input type="text" class="form-control" placeholder="Цена" name="cost">
                    </div>
                    <div class="form-group col-sm">
                        <label for="transfer">Деньги в : </label>
                        <select
                            name="transfer"
                            id="transfer"
                            class="form-control"
                ...
                <div class="card shadow mb-4 mt-3">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">Оплата, Обмен</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Изменить 1</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Изменить 2</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Изменить 3</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Изменить 4</td>
