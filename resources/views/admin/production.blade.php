@extends("layouts.app", ['title' => "Производство"])
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container-fluid">
                <h2 class="mb-4 text-center">Производство</h2>
                <div class="row">
                    <div class="form-group col-sm">
                        ...
                        <select
                            ...
                            class="form-control"
                        >
                            <option value="">Готовый 1</option>
                            <option value="">Готовый 2</option>
                            <option value="">Готовый 3</option>
                        </select>
                    </div>
                    <div class="form-group col-sm">
                        <label
                ...
                >
                    ...
                    <div class="card shadow mb-4 mt-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Производство</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">2020/02/05</td>
                                    </tr>
                                    <tr class="text-center">
