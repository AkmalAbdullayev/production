@extends("layouts.app", ["title" => "Возврат"])
...
@section("refund")
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container">
                <h2 class="text-center mb-4">Возврат</h2>
                <div class="row">
                    <div class="form-group col-sm">
                        <label for="ready">Возврат</label>
                ...
                >
                    <div class="card shadow mb-4 mt-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">Возврат</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Возврат 1</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Возврат 2</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Возврат 3</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Возврат 4</td>
