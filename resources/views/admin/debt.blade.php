@extends("layouts.app", ["title" => "Отчет Долгов"])
...
@section("debt")
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container">
                <h2 class="text-center">Отчет Долгов</h2>

                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a href="#" class="nav-link active">Долг нам</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">Мы должны</a>
                    </li>
                </ul>
                <div
                    class="myTable"
                ...
                >
                    <div class="card shadow mb-4 mt-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Отчет Долгов</h6>
                        </div>
                        <div class="card-body">
