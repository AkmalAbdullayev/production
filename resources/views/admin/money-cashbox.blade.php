...
@section("cashbox")
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container">
                <h2 class="text-center mb-4">Касса</h2>
                <div class="row">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-items">
                        <a href="#" class="nav-link">Сум</a>
                    </li>
                    <li class="nav-items">
                        <a href="#" class="nav-link">Перечисление</a>
                    </li>
                </ul>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Инфо 1</td>
                                        <td class="text-center">Содержание 1</td>
                                    ...
                                    <tr>
                                        <td class="text-center">1</td>
                                        <td class="text-center">Инфо 2</td>
                                        <td class="text-center">Содержание 2</td>
                                    ...
                                    <tr>
                                        <td class="text-center">1</td>
                                        <td class="text-center">Инфо 3</td>
                                        <td class="text-center">Содержание 3</td>
                                    ...
                                    <tr>
                                        <td class="text-center">1</td>
                                        <td class="text-center">Инфо 4</td>
                                        <td class="text-center">Содержание 4</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">-222255488</td>
                                        <td class="text-center">-256789123</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
