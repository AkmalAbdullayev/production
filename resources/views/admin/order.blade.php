@extends("layouts.app", ["title" => "Заказ"])
...
@section("order")
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container">
                <h2 class="text-center mb-4">Заказ</h2>
                <div class="row mt-3">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm">
                        <label for="prepayment">Заклад</label>
                    ...
                    <div class="form-group col-sm">
                        ...
                        <input type="date" class="form-control" name="shipping">
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="card shadow mb-4 mt-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Заказ</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">Заклад</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Заклад 1</td>
                                        <td class="text-center">100 000</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Заклад 2</td>
                                        <td class="text-center">150 000</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Заклад 3</td>
                                        <td class="text-center">200 000</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">61</td>
                                        <td class="text-center">200 000</td>
                                        <td class="text-center">Заклад 4</td>
                                        <td class="text-center">200 000</td>
                                        <td class="text-center">2020/02/12</td>
                                        <td class="text-center">2020/02/12</td>
                                        <td class="text-center">
                                            <span class="fas fa-trash-alt"></span>
                                        </td>
