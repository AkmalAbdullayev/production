@extends("layouts.app", ["title" => "Остаток на готовый"])
            ...
            <div class="container mt-2">
                <div class="card">
                    <div class="card-header">
                        <h2 class="h5 mb-0">Остаток на готовый</h2>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card shadow mb-4 mt-3">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">Остаток на готовый</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Витрина 1</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">litr</td>
                                    <td class="text-center">8</td>
                                    <td class="text-center">14 000</td>
                                    <td class="text-center">140 000</td>
                                    <td class="text-center">Витрина 2</td>
                                    <td class="text-center">5</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">140 000</td>
                                    <td class="text-center">Витрина 3</td>
                                    <td class="text-center">5</td>
                                </tr>
                                </tbody>
                            </table>
