@extends("layouts.app", ["title" => "Расход"])
...
@section("consumption")
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container">
                <h2 class="text-center mb-4">Расход</h2>
                <div class="row mt-3">
                    ...
                    <div class="form-group col-sm-5">
                        <label for="ready">Категория расхода</label>
                        <select
                            name="client"
                            id="client"
                            class="form-control"
                ...
                <div class="row">
                    <div class="form-group col-sm">
                        <label for="cost">Наименование</label>
                ...
                <div class="card shadow mb-4 mt-3 w-100">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">Расход</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Категория расхода</th>
                                    <th class="text-center">Клиент</th>
                                    <th class="text-center">Наименование</th>
                                    <th class="text-center">Денги</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Категория 1</td>
                                    <td class="text-center">Клиент 1</td>
                                    <td class="text-center">Наименование 1</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Категория 2</td>
                                    <td class="text-center">Клиент 2</td>
                                    <td class="text-center">Наименование 2</td>
                                    <td class="text-center">rub</td>
                                    <td class="text-center">20</td>
                                    <td class="text-center">200 000</td>
                                    <td class="text-center">2020/08/02</td>
                                    <td class="text-center">752 000</td>
                                    <td class="text-center">
                                        <span class="fas fa-trash-alt"></span>
                                    </td>
                                </tr>
