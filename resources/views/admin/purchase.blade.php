@extends("layouts.app", ["title" => "Покупок"])
                        ...
                        <div class="row">
                            <div class="form-group col-sm">
                                ...
                                <select
                                    ...
                                    name="refund"
                                >
                                    <option value="1">Готовый 1</option>
                                    <option value="2">Готовый 2</option>
                                    <option value="3">Готовый 3</option>
                                </select>
                            </div>
                            <div class="form-group col-sm">
                ...
                >
                    <div class="card shadow mb-4 mt-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Покупок</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Склад 1</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Склад 2</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Склад 3</td>
